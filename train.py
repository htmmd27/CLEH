...
for epoch in range(Epoch_num):
    ...
    LatentPresentation_A = H_mean_A.cpu().detach().numpy()
    LatentPresentation_C = H_mean_C.cpu().detach().numpy()
    LatentPresentation_T = H_mean_T.cpu().detach().numpy()
    ...
    LatentPresentation_P = H_mean_P.cpu().detach().numpy()
